...
/** Points at one of the six illustrated animal photos shipped under public/assets for demo profiles. */
function petPhoto(species: Pet['species'], variant: number): string {
  return `/assets/${species}${variant}.png`
}

const corePets: Pet[] = [
  { id: 'p-1', customerId: 'c-1', name: 'Balu', species: 'dog', initials: 'BA', color: '#DCE9E5', note: 'Bitte mit dem gewohnten Futter füttern. Morgens und abends je 180 g des mitgebrachten Trockenfutters; kein Rind. Schilddrüsenmedikament: 1 Tablette täglich um 18 Uhr mit dem Abendfutter. Unverträglichkeit gegen Rind; keine Rinderleckerlis geben. Impfpass geprüft: Staupe, Hepatitis, Parvovirose und Tollwut gültig bis März 2027. Tierarztpraxis am Park, 030 554 82 19.', specialFood: true, photoUrl: petPhoto('dog', 1) },
  { id: 'p-2', customerId: 'c-2', name: 'Milo', species: 'cat', initials: 'MI', color: '#F3E3D7', photoUrl: petPhoto('cat', 1) },
  { id: 'p-3', customerId: 'c-3', name: 'Luna', species: 'dog', initials: 'LU', color: '#E8E1F0', photoUrl: petPhoto('dog', 2) },
  { id: 'p-4', customerId: 'c-4', name: 'Nala', species: 'cat', initials: 'NA', color: '#E5E9D8', note: 'Bitte nur das mitgebrachte Futter verwenden.', specialFood: true, photoUrl: petPhoto('cat', 2) },
  { id: 'p-5', customerId: 'c-5', name: 'Rocky', species: 'dog', initials: 'RO', color: '#DCE7F0', photoUrl: petPhoto('dog', 3) },
  { id: 'p-6', customerId: 'c-6', name: 'Frieda', species: 'dog', initials: 'FR', color: '#F1E1D5', photoUrl: petPhoto('dog', 4) },
  { id: 'p-7', customerId: 'c-7', name: 'Simba', species: 'cat', initials: 'SI', color: '#E2E8D8', photoUrl: petPhoto('cat', 3) },
  { id: 'p-8', customerId: 'c-8', name: 'Oskar', species: 'dog', initials: 'OS', color: '#E9DDE8', photoUrl: petPhoto('dog', 5) },
  { id: 'p-9', customerId: 'c-9', name: 'Loki', species: 'cat', initials: 'LO', color: '#DCE8ED', photoUrl: petPhoto('cat', 4) },
  { id: 'p-10', customerId: 'c-10', name: 'Maja', species: 'dog', initials: 'MA', color: '#EEE5D6', photoUrl: petPhoto('dog', 6) },
  { id: 'p-11', customerId: 'c-11', name: 'Pepe', species: 'dog', initials: 'PE', color: '#DFE7DC' },
  { id: 'p-12', customerId: 'c-12', name: 'Minou', species: 'cat', initials: 'MN', color: '#E5E1EF', photoUrl: petPhoto('cat', 5) },
